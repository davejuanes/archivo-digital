...
{{--    Fin iconos sistema--}}
    ...
    <link rel="stylesheet" href="{{asset('assets/css/pages/dashboard/analytic.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/pages/dashboard/crypto-currency.min.css')}}" />
